  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-4 rounded-md bg-destructive/10 p-4 text-left border border-destructive/20">
          <p className="text-xs font-mono text-destructive break-words">
            {error.message || String(error)}
          </p>
          {error.stack && (
            <pre className="mt-2 text-[10px] font-mono text-destructive/70 whitespace-pre-wrap">
              {error.stack}
            </pre>
          )}
        </div>
